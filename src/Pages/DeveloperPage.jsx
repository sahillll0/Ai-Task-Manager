...
import { Github, Linkedin, Instagram, Mail, ExternalLink, Code2, Terminal, Cpu, Globe, Database, Star, GitFork, Command } from 'lucide-react';
            ...
            <div className="min-h-full w-full bg-[#09090b] text-white overflow-hidden relative selection:bg-purple-500/30">
                ...
                <div className="max-w-6xl mx-auto p-6 md:p-12 relative z-10 space-y-16">
                    ...
                    <div className="border border-zinc-800 rounded-2xl bg-zinc-900/30 p-8 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-white mb-2">AI Task Manager</h2>
                        <p className="text-zinc-400 max-w-xl mx-auto mb-6">
                            Building a smart task management ecosystem powered by artificial intelligence to revolutionize personal productivity.
                        </p>
