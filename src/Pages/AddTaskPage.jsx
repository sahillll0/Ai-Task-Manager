...
import { Sparkles, Calendar, Clock, Flag, Plus, X, Save, ArrowLeft, ListChecks, Hourglass, CheckCircle, PauseCircle, Loader2 } from 'lucide-react';
...
const AddTaskPage = () => {
            ...
            try {
                await axios.post(`${import.meta.env.VITE_BACKEND_URL}/task/addTask`, task, {
                    ...
                    .catch((err) => {
                        ...
                        const error = err.response.data.message || "Task Added Failed";
    ...
    return (
        <Layout>
            ...
            <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-8">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold text-white tracking-tight">Create New Task</h1>
                            <p className="text-zinc-500 text-sm mt-1">Define your task details and let AI assist you.</p>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setAiEnhance(true)}
                                    className="cursor-pointer flex items-center gap-1.5 text-xs font-medium text-purple-400 hover:text-purple-300 transition-colors px-3 py-1.5 rounded-lg bg-purple-500/10 border border-purple-500/20 hover:bg-purple-500/20"
                                >
            ...
            {/* AI Modal */}
            {aiEnhance && (
                <form onSubmit={handleSubmit} className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 space-y-4 animate-in zoom-in-95 duration-200">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-purple-400">
                                <Sparkles className="w-5 h-5" />
                                <h3 className="font-semibold text-lg text-white">AI Task Creator</h3>
                            </div>
                            <button
                        ...
                        <p className="text-zinc-400 text-sm">
                            Describe the task you want to create, and let AI structure it for you.
                        </p>

                        <textarea
                            value={aiInput.aiInput}
                            onChange={(e) => setAiInput({ ...aiInput, aiInput: e.target.value })}
                            placeholder="e.g. Create a marketing plan for the new product launch..."
                            className="w-full h-32 bg-zinc-950 border border-zinc-800 rounded-xl p-4 text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 resize-none transition-all"
                        />
                        ...
                        <div className="flex justify-end gap-3 pt-2">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white text-sm font-bold rounded-xl transition-all shadow-lg hover:shadow-purple-500/20 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98]"
                            >
                                {isGenerating ? (
                                    <>
